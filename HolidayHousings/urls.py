...
urlpatterns = [
    ...
    path('comment/report/<int:comment_id>/', views.report_comment, name='report-comment'),  # New path for reporting comments
    path('show/<int:pk>/edit/', views.housing_edit, name='housing-edit'),
